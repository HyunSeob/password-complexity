...
function additionalComplexityForCharset(str, charset) {
  return str.split('').map(function (v) {
    ...
    return charset[0] <= v && v <= charset[1];
  }).length ? charset[1] - charset[0] + 1 : 0;
}
